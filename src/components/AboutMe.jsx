...
import thurunu from "../assets/thurunu.png";
    ...
    <section id="about" className="mt-2 py-20 min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-10 h-full">
        <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto h-full">
          ...
          <div className={`${styles.box} ${styles.leftBox} sm:order-2 lg:order-1 sm:flex flex-1 p-6 rounded-[6px] shadow-md`}>
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-white text-m leading-relaxed text-m">
                ...
                expertise with creative problem-solving. Throughout my academic
                ...
                deliver real value. I am always eager to learn, take on new
                challenges, and grow within the ever-evolving tech landscape. I
                welcome opportunities to connect with fellow innovators, tech
          ...
          {/* Middle Box */}
          <div className={`${styles.box} ${styles.middleBox} sm:order-1 lg:order-2 flex-1 p-6 rounded-[6px] shadow-md`}>
            <div className="w-full">
              <img src={thurunu} alt="myimage" className="mt-20"/>
            </div>
          </div>
